...
if __name__ == '__main__':
    ...
    svc = svc.fit(train_data_features, train["sentiment"])
    ...
    result = svc.predict(test_data_features)
    ...
    output.to_csv(os.path.join(os.path.dirname(__file__), 'data', 'Bag_of_Words_model_SVM_tfidf_LN.csv'), index=False, quoting=3 )
